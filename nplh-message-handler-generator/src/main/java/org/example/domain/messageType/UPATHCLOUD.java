...
import org.example.domain.ws.UPATHCLOUD.UPATHCLOUDToNPLH.SendSlideWSAData.UPATHCLOUD_SendSlideWSAData;
...
public enum UPATHCLOUD implements MessageType {
    ...
    sendSlideWSAData {
        public MessageService.MessageResponse convert(Message m, Slide slide, String status) {
            UPATHCLOUD_SendSlideWSAData sendSlideWSAData = UPATHCLOUD_SendSlideWSAData.FromMessage(m, slide, status);
