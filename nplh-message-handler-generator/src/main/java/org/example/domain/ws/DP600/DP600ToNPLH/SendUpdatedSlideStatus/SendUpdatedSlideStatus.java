...
@Data
@NoArgsConstructor
public class SendUpdatedSlideStatus  extends WSSegment {
    ...
    public static SendUpdatedSlideStatus FromMessage(Slide slide, String status) {
        SendUpdatedSlideStatus sendUpdatedSlideStatus = new SendUpdatedSlideStatus();
