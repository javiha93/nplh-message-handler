...
public class VTG_SpecimenUpdate extends HL7Segment {
    MSH msh;
    PID pid;
    SAC sac;
    ORC orc;
    ...
    public static VTG_SpecimenUpdate FromMessage(Message message, Specimen specimen, String specimenStatus) {
        VTG_SpecimenUpdate specimenUpdate = new VTG_SpecimenUpdate();
