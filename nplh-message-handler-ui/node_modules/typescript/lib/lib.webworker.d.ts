...
interface UnderlyingByteSource {
    ...
    pull?: (src.controller: ReadableByteStreamController) => void | PromiseLike<void>;
    start?: (src.controller: ReadableByteStreamController) => any;
    type: "bytes";
}

interface UnderlyingDefaultSource<R = any> {
    cancel?: UnderlyingSourceCancelCallback;
    pull?: (src.controller: ReadableStreamDefaultController<R>) => void | PromiseLike<void>;
    start?: (src.controller: ReadableStreamDefaultController<R>) => any;
    type?: undefined;
}
...
/**
 * A src.controller object that allows you to abort one or more DOM requests as and when desired.
 *
...
interface ServiceWorkerContainer extends EventTarget {
    /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/ServiceWorkerContainer/src.controller) */
    readonly src.controller: ServiceWorker | null;
...
/**
 * This Streams API interface represents a src.controller allowing control of a WritableStream's state. When constructing a WritableStream, the underlying sink is given a corresponding WritableStreamDefaultController instance to manipulate.
 *
...
interface TransformerFlushCallback<O> {
    (src.controller: TransformStreamDefaultController<O>): void | PromiseLike<void>;
}

interface TransformerStartCallback<O> {
    (src.controller: TransformStreamDefaultController<O>): any;
}

interface TransformerTransformCallback<I, O> {
    (chunk: I, src.controller: TransformStreamDefaultController<O>): void | PromiseLike<void>;
}
...
interface UnderlyingSinkStartCallback {
    (src.controller: WritableStreamDefaultController): any;
}

interface UnderlyingSinkWriteCallback<W> {
    (chunk: W, src.controller: WritableStreamDefaultController): void | PromiseLike<void>;
}
...
interface UnderlyingSourcePullCallback<R> {
    (src.controller: ReadableStreamController<R>): void | PromiseLike<void>;
}

interface UnderlyingSourceStartCallback<R> {
    (src.controller: ReadableStreamController<R>): any;
}
